      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url();?>index.php/admin/add_thmxt">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Thêm tổ hợp môn xét tuyển</p> 
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url();?>index.php/admin/get_list_thmxt">
                    <i class="far fa-circle nav-icon"></i>
                    <p Xem tổ hợp môn xét tuyển</p> 
                  </a>
                </li>
            </ul>
          </li> -->
