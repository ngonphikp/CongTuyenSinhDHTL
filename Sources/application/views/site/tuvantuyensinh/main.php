                            ...
                            <div class="region region-content">
                                <div class="view-filter" style="display:flex;">
                                    ...
                                    <div class="filter2 ml-4" style="margin-left: 10px;">
                                        ...
                                        <br />
                                        <select name="danh-muc" id="filter" class="form-select required" style="padding: 3px;">
                                ...
                                <div class="view-content">
                                    <div class="item-list">
                                        <ul class="list__news" style="padding-left: 14px;padding-top:20px;">
                                            <li id="news--item">
                                                <a href="">E muốn hỏi phương thức xét học bạ cần làm gì ạ -
                                                    <span>(1 ngày 3 giờ trước )</span></a>
                                            </li>
                                            <li id="news--item">
                                                <a href="">E muốn hỏi phương thức xét học bạ cần làm gì ạ -
                                                    <span>(1 ngày 3 giờ trước )</span></a>
                                            ...
                                            <li id="news--item">
                                                <a href="">Cho em hỏi em đã đăng kí xét học bạ trực tuyến, vậy
                                                    em phải chờ bao lâu để nhận được email báo đăng kí
                                                    thành công ạ? -
                                                    <span>(4 ngày 3 giờ trước )</span></a>
                                            </li>
                                            <li id="news--item">
                                                <a href="">Cho em hỏi em đã đăng kí xét học bạ trực tuyến, vậy
                                                    em phải chờ bao lâu để nhận được email báo đăng kí
