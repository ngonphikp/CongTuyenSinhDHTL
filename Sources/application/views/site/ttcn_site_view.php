            ...
            <div class="row register-form">
                <form class="custom-form" method="post" action="<?php echo base_url() . 'index.php/home/pro_ttcn/' .$user['id_tk']; ?>">
                    ...
                    <div class="form-row form-group">
                        ...
                        <div class="col-sm-6 input-column"><input name="ht" class="form-control hide-update" type="text" value="<?php echo $user['ho_ten'];?>"></div>
                    </div>
                    <div class="form-row form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="Sex">
                                ...
                                <div class="form-check"><input class="form-check-input hide-update" type="radio" name="gt" value="Nữ" <?php if ($user['gioi_tinh'] === "Nữ")echo "checked";?>><label class="form-check-label hide-update">Nữ</label></div>
                            </div>
                        </div>
                    </div>
                    <div class="form-row form-group">
                        <div class="col-sm-4 label-column"><label class="col-form-label">Email</label></div>
                        <div class="col-sm-6 input-column"><input name="email" class="form-control hide-update" type="text" value="<?php echo $user['email'];?>"></div>
                    </div>
                    <div class="form-row form-group">
                        <div class="col-sm-4 label-column"><label class="col-form-label">Ngày Sinh</label></div>
                        <div class="col-sm-6 input-column"><input name="ns" class="form-control hide-update" type="date" value="<?php echo $user['ngay_sinh'];?>"></div>
                    </div>
                    <div class="form-row form-group">
                        <div class="col-sm-4 label-column"><label class="col-form-label">Số Điện Thoại</label></div>
                        <div class="col-sm-6 input-column"><input name="sdt" class="form-control hide-update" type="text" value="<?php echo $user['sdt'];?>"></div>
                    </div>
                    <div class="form-row form-group">
                        <div class="col-sm-4 label-column"><label class="col-form-label">Địa Chỉ</label></div>
                        <div class="col-sm-6 input-column"><input name="dc" class="form-control hide-update" type="text" value="<?php echo $user['dia_chi'];?>"></div>
                    </div>
