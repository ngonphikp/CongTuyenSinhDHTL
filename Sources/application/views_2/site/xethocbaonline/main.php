    ...
    <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="c" required="required" name="ten" placeholder="Họ, chữ đệm và tên của thí sinh">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="" required="required" placeholder="Họ, chữ đệm và tên của thí sinh">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
        ...
        <div class="col-md-12 col_nop_tl" style="display:none;">
            ...
            <div class="row row_nop_hs">
                ...
                <label for="">
                    <i class="fa fa-minus" aria-hidden="true"></i>
                    Nộp kèm file chứng minh và hoàn thành hồ sơ
                </label>
                </div>
            </div>
            <div class="row nop_ho_so" >
                <div class="col-md-12" style="padding-top: 30px;">
                    ...
                    <input type="file" style="border:1px solid #ccc;width: 100%;padding: 5px;">
                </div>
            </div>
            <div class="row" style="padding:15px 0;">
                <div class="col-md-12">
